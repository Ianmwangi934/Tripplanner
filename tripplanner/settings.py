...
SECRET_KEY = 'django-insecure-lm&6o^-5qudk38@c42oaxw#xmy*=exs0hr@qd%iqx*alsbzp$%'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS =os.getenv("DJANGO_ALLOWED_HOSTS","127.0.0.1,localhost,tripplanner-2.onrender.com,tripplanner-eight.vercel.app").split(",")
